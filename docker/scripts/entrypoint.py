...
def hdr_start():
    ...
    run_command("source /opt/ros/humble/setup.bash; cd /workspaces/ros2_ws; source install/setup.bash; ros2 launch rosbag2_composable_recorder recorder.launch.py")
